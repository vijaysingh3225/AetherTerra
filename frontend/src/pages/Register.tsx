...
export function Register() {
  ...
  if (submitted) {
    return (
      <div className="surface-panel mx-auto max-w-sm p-8 text-center">
        <div className="mb-4 text-3xl text-[var(--accent)]">✦</div>
        <h2 className="mb-2 text-2xl font-light text-[var(--text-primary)]">Check your email</h2>
  ...
  return (
    <div className="surface-panel mx-auto max-w-sm p-8">
      <p className="eyebrow-label mb-4 text-xs font-medium">Join the Floor</p>
      <h2 className="mb-2 text-2xl font-light text-[var(--text-primary)]">Create Account</h2>
      ...
      <p className="mt-5 text-center text-sm text-[var(--text-secondary)]">
        ...
        <Link to="/login" className="accent-link underline underline-offset-4">Sign In</Link>
      </p>
    </div>
  )
}
